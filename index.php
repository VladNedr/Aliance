  ...
  <body class="front-page">
      ...
      <div class="mobile-menu-toggle">
        ...
        <ul class="navbar-nav">
          <li class="navbar-nav-item">
            <a href="/about.html" class="navbar-nav-link">О компании</a>
          </li>
          <li class="navbar-nav-item">
    ...
    <section class="section cta">
      <div class="bg-grey section-cta ">
        <img src="img/cta.png" alt="coll to action" class="cta-image">
    ...
    <div class="modal">
      <div class="modal-dialog">
        ...
        <form action="#" class="modal-form">
          ...
          <div class="modal-form-footer modal-form-footer">
